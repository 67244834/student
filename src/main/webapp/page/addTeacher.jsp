...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/Teacher/addTeacher.do">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="tid" value="" data-validate="required:请输入工号"/>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <div class="field">
                        <input type="text" class="input w50" name="worktime" value="" data-validate="member:只能为数字" data-validate="required:请输入工作年龄" />
                    </div>
                </div>
            </div>
            <div class="form-group">
